...
<html>
    ...
    <body>
        ...
        <div class="fundo-branco botao">
            <h1 class="titulo-roxo"  style="text-align:center">SESSÃO DE ENCERRAMENTO</h1>
            <h2 class="titulo-roxo"></h2>
            <form method="post" action="assets/database/pontos.php">
                <button class="pontos-botao"type="submit" name="encerramento">Sessão de Encerramento</button>
            </form>
        </div>
