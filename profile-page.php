    ...
    <body>
        ...
        <?php if ($user['email'] == "admin@gmail.com"):?>
            <div class="fundo-branco-admin">
                <div class="titulo-roxo" style="margin-top: 150px; margin-bottom: 50px;">ADMIN ACCOUNT</div>
                <div class="button-row">
                    <a href="https://tally.so/forms/mYWBOd/submissions"><button class="button-admin" style="margin-right: 8px;">CV SUBMISSIONS</button></a>
                    <a href="admin_validate_cv.php"><button class="button-admin" style="margin-right: 8px;">VALIDATE CV</button></a>
                    <a href="admin_validate_kit.php"><button class="button-admin">ENTREGA DO KIT</button></a>
                </div>
                <a class="button-admin-link" href="assets/database/logout.php" style="margin-top: 100px">Log Out</a> 
            </div>
        <?php endif; ?>
            ...
            <div class="profile">
                ...
                <div class="pessoal-dir fundo-branco">
                    <div class="linha-topo-botoes" style="margin-bottom: 15px;">
                        <button class="botao-cv" data-tally-open="mYWBOd" data-tally-width="600" data-tally-overlay="1" data-tally-auto-close="0">SUBMETE AQUI O TEU CV</button>
                        <?php if ($user["cv"] == 1):?>
                    ...
                    <div class="grid-container">
                        ...
                        <div class="grid-item">
                                <img src="assets/img/atividades/signup-complete.png" alt="Image 1">
                        </div>
                        <div class="grid-item">
                        ...
                        <div class="grid-item">
                            <?php if ($user["fe_accenture"] == 1):?>
                                <img src="assets/img/atividades/accenture-complete.png" alt="Image 1">
                            <?php endif; ?>
                            <?php if ($user["fe_accenture"] == 0):?>
                                <img src="assets/img/atividades/accenture.png" alt="Image 1">
                            <?php endif; ?>
                        </div>
                        <div class="grid-item">
